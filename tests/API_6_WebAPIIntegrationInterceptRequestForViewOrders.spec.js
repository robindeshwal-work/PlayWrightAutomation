...
test('Order API Integration with UI test', async ({ page }) => {
    ...
    await page.locator("button[routerlink*='myorders']").click();
      ...
      // Intercept Order id in Request Endpoint of View Order
    await page.route("https://rahulshettyacademy.com/api/ecom/order/get-orders-details?id=*",
    route =>
        // Give some random order id in the url which doesn't exist for that user to mock unauthorized error
        route.continue({url:"https://rahulshettyacademy.com/api/ecom/order/get-orders-details?id=691551de5008f6a909aaddvv"})
    );
    //    await page.pause();
